...
public class SurveyServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (step.equals("a")) {
            ...
            // Sanitize the email parameter to prevent XSS
            String email = request.getParameter("txtEmail").replaceAll("<", "&lt;").replaceAll(">", "&gt;");
            content = "<h1>Thanks</h1>" +
                    "<div width=\"99%\"><p>Thanks for your entry.  We will contact you shortly at:<br /><br /> <b>" + email + "</b></p></div>";
            previousStep = "email";
        } else {
