            ...
            <form name="cmt" method="post" action="sendFeedback">
                ...
                <table border="0">
                    ...
                    <tr>
                        ...
                        <td valign="top"><input name="name" size="25" type="text" value="<%= ((user != null && user.getFirstName() != null)?sanitize(user.getFirstName())+" ":"") + ((user != null && user.getLastName() != null)?sanitize(user.getLastName()):"") %>"></td>
                    </tr>
                    <tr>
...
<%!
    private String sanitize(String input) {
        // Replace special characters with HTML entities to prevent XSS
        input = input.replace("&", "&amp;")
                     .replace("<", "&lt;")
                     .replace(">", "&gt;")
                     .replace("\"", "&quot;")
