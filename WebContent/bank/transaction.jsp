    ...
    <td valign="top" colspan="3" class="bb">
        ...
        <table border="0" style="padding-bottom:10px;">
            <tr>
                ...
                <td><input id="startDate" name="startDate" type="text" value="<%=escapeHtml(request.getParameter("startDate")==null ? "" : request.getParameter("startDate"))%>"/><br /><span class="credit">yyyy-mm-dd</span></td>
                <td valign=top>Before</td>
                <td><input name="endDate" id="endDate" type="text" value="<%=escapeHtml(request.getParameter("endDate")==null ? "" : request.getParameter("endDate"))%>"/><br /><span class="credit">yyyy-mm-dd</span></td>
        ...
        <table cellspacing="0" cellpadding="3" rules="all" border="1" id="_ctl0__ctl0_Content_Main_MyTransactions" style="width:100%;border-collapse:collapse;">
            ...
            %>
                ...
                <tr><td><%=escapeHtml(transactions[i].getTransactionId())%></td><td><%=escapeHtml(date)%></td><td><%=escapeHtml(transactions[i].getAccountId())%></td><td><%=escapeHtml(transactions[i].getTransactionType())%></td><td align="right"><%=escapeHtml(amount)%></td></tr>
            <% } %>
        <tr>
